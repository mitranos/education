...
define('DB_HOST', 'mybenightdbinstance.cjl9zr4qicln.eu-west-1.rds.amazonaws.com');
define('DB_NAME', 'mybenightdb');
define('DB_USER', 'admin');
define('DB_PASS', 'benight123');
...
// the domain where the cookie is valid for, for local development ".127.0.0.1" and ".localhost" will work or False
// IMPORTANT: always put a dot in front of the domain, like ".mydomain.com" !
define('COOKIE_DOMAIN', "127.0.0.1");
//
//IMPORTANT: for development in localhost set bese path to FALSE or ""
...
// name of your host
define("EMAIL_SMTP_HOST", 'benight.it');
// leave this true until your SMTP can be used without login
define("EMAIL_SMTP_AUTH", true);
// SMTP provider username
define("EMAIL_SMTP_USERNAME", 'noreply@benight.it');
// SMTP provider password
define("EMAIL_SMTP_PASSWORD", 'benight123');
// SMTP provider port
define("EMAIL_SMTP_PORT", 465);
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@benight.it");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "My Project");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for PROJECT XY");
define("EMAIL_PASSWORD_RESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@benight.it");
define("EMAIL_VERIFICATION_FROM_NAME", "My Project");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for PROJECT XY");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
