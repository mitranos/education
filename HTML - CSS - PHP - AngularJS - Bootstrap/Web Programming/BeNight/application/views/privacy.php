    ...
    <section class="privacy">
    	<div alt="Contact Us" class="img privacy">
    		
  		</div>
        <div class="container">
        <h3>Privacy Policy</h3><br>
        This Privacy Policy governs the manner in which BeNight llc. collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="www.benight.co">www.benight.co</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by BeNight llc..<br><br>
...
BeNight llc. may collect and use Users personal information for the following purposes:<br>
<ul>
...
By using this Site, you signify your acceptance of this policy and <a href="www.benight.co/terms">terms of service</a>. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes.<br><br>

<b>Contacting us</b><br><br>

If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at:<br>
<a href="www.benight.co">BeNight llc.</a><br>
<a href="www.benight.co">www.benight.co</a><br>
Be NIght llc. , 2500 eagle run dr., Weston, FL, 33327<br>
+1 (786) 853-2763<br>
info@benight.co<br>
<br>
This document was last updated on September 21, 2014<br><br>
		</div>
      </section>
    <!-- CONTACTS END-->