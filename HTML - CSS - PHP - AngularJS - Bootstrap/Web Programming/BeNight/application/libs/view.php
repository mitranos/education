...
class View
{
     ...
     */
    public function render($filename, $view = false ,$render_without_header_and_footer = false)
    {
        // page without header and footer, for whatever reason
        if ($render_without_header_and_footer == true) {
            require VIEWS_PATH . $filename . '.php';
        } else {
			require VIEWS_PATH . 'require/head.php';
            require VIEWS_PATH . 'require/header.php';
			require VIEWS_PATH . 'require/modals.php';
            require VIEWS_PATH . $filename . '.php';
            require VIEWS_PATH . 'require/footer.php';
			require VIEWS_PATH . 'require/foot.php';
        }
    }
