...
void Account::displayStatement()
{
	displayLabels();
	cout.precision(2);
	cout << fixed << setw(11) << openingBalance << " opening balance" << endl;
	displayTransactions();
	cout << fixed << setw(11) << getBalance() << " closing balance" << endl;
}

void Account::displayLabels()
{
	cout << fixed << "day " << setw(12) << " amount description" << endl;
}
